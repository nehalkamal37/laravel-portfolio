          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{ asset('uploads/projects/'.$project->image2)}}"
                  alt="">
                                </div>

                <div class="swiper-slide">
                  <img src="{{ asset('uploads/projects/'.$project->image3)}}"
                  alt="">                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project date</strong>: {{$project->created_at->format('d/m/Y') }}</li>
