...
<head>
	...
	<!-- vector map CSS -->
    <link href="{{ asset('dash/vendors/vectormap/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                <img class="brand-img d-inline-block" src="{{ asset('dash/dist/img/logo-dark.png')}}" alt="brand" />
            </a>
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <div class="dropdown-divider"></div>
                        <i class="dropdown-icon zmdi zmdi-power"></i><span>
                            <a href="{{ route('logout')}}">Log out</a></span>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                     ...
                     <span class="nav-link-text"><a  style="margin-left: 22px;" href="{{ route('users.index')}}">User Data</a></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#auth_drp">
                                ...
                                <span class="nav-link-text"><a style="margin-left: 22px;" href="{{ route('cv.index')}}">CV Data</a></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#pages_drp">
                                ...
                                <span class="nav-link-text"><a  style="margin-left: 22px;" href="{{ route('skills.index')}}">Skills</a></span>
                            </a>

                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#pages_drp">
                                <span class="feather-icon"><i data-feather="file-text"></i></span>
                                <span class="nav-link-text"><a  style="margin-left: 22px;" href="{{ route('projects.index')}}">Projects</a></span>
                            </a>

                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#pages_drp">
                                <span class="feather-icon"><i data-feather="file-text"></i></span>
                                <span class="nav-link-text"><a  style="margin-left: 22px;" href="{{ route('msg.index')}}">messages</a></span>
                            </a>
    ...
    <script src="{{ asset('dash/vendors/vectormap/jquery-jvectormap-2.0.3.min.js')}}"></script>
    <script src="{{ asset('dash/vendors/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{ asset('dash/dist/js/vectormap-data.js')}}"></script>
	...
	<script src="{{ asset('dash/dist/js/dashboard-data.js')}}"></script>
